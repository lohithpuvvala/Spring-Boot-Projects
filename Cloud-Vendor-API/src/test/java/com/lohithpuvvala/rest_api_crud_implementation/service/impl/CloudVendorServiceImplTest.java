...
class CloudVendorServiceImplTest {
    ...
    void testGetCloudVendorById() {
        ...
        assertThat(cloudVendorService.getCloudVendorById("1").getVendorName()).isEqualTo(cloudVendor.getVendorName());
    }
    ...
    void testDeleteCloudVendor() {
        ...
        assertThat( cloudVendorService.deleteCloudVendor("1"))
                .isEqualTo("Successfully deleted cloud vendor");
    }
}
